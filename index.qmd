---
title: "Parker Leipzig" # change this to your name
...
about:
  ...
  links: 
    - icon: envelope
      text: Contact Me
      href: mailto:pleipzig01@hamline.edu # change to your email
    - icon: linkedin
      href: https://linkedin.com. # change to your linkedin address
    - icon: github
      href: https://github.com/parkerleipzig5 # change to your github address
    - icon: twitter
